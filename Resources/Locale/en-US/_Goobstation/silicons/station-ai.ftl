station-ai-icon-hypermoth = Mothroach
station-ai-icon-screensaver = Screensaver
station-ai-icon-seesyou = Eye
station-ai-icon-earnest = Earnest
station-ai-icon-brain = Brain in a box
station-ai-icon-obey = OBEY
...
station-ai-earlyleave-announcement = {$character} (Station AI) has entered hibernation!
